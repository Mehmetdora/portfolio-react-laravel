    ...
    const bioEvents = [
        {
            ...
            description:
                "Completed my first internship at SEYTİM, working with Laravel framework.",
            icon: Briefcase,
        },
        {
            year: "2021-2022",
            title: "Started at Çukurova University – English Preparatory Year",
            description:
                "Improved my English to a functional level necessary for my academic and professional goals.",
            icon: GraduationCap,
        },
        {
            year: "2017",
            ...
            description:
                "Focused on career path selection and personal development.",
            icon: Award,
        },
    ];
